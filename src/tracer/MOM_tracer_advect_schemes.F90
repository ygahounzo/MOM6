...
! The following are public parameter constants
  ...
  integer, parameter :: ADVECT_PPMWENO5  = 5 !< WENO5 advection scheme
  integer, parameter :: ADVECT_PPMWENO7  = 6 !< WENO7 advection scheme
...
!> Documentation for tracer advection schemes
  character(len=*), parameter :: TracerAdvectionSchemeDoc = &
    ...
    "  PPM:W5  - hybrid PPM and Weighted Essentially Non-Oscillatory, 5th order\n"//&
    "  PPM:W7  - hybrid PPM and Weighted Essentially Non-Oscillatory, 7th order"
